...
<body>
  ...
  <main>
    ...
    <div class="signUpPage">
      <h1>Sign up</h1><br>
      <p class="signUpText">In order to purchase from the Student's Union shop, you need to create an account with all
        fields below required. If you have any difficulties with the form please contact the webmaster(hyperlink needed)

      <p>Full Name: </p>
      <input type="text" class="inputBar" id="name">
      <p>Email address:</p>
      <input type="email" class="inputBar" id="email">
      <p>Password: </p>
      <p class="passwordText">Must contain at least one number and one uppercase and lowercase letter, and at least 8 or
        more characters</p>
      ...
      <input type="password" class="inputBar" id="password">
      <p>Address: </p>
      <input type="text" class="inputBar" id="address">
